...
| R3.0 | May 2024 | Details TBD|
| R4.0 | September 2025 | Details TBD|
...
NOTE: The video refers to SDR 3.0, but that all the functionality is the same in SDR 4.0, minus the authentication.

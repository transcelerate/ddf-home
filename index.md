...
The Digital Data Flow (DDF) initiative aims to modernize clinical trials by enabling a digital workflow that allows for automated creation of study content and configuration of study systems to support clinical trial execution. See the section [What is DDF?](#what-is-ddf) for more information on the objective and benefits of DDF.

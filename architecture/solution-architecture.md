...
| ![Authentication and Authorization Workflows](images/solution-architecture-03-authentication-and-authorization-workflows.png) |
|:-----------------------------------------------------------------------------------------------------------------------------:|
...
| ![Deployment Models](images/solution-architecture-08-deployment-models.png) |
|:---------------------------------------------------------------------------:|
|                             *Deployment Models*                             |
